    ...
    mapSVG = function(elem, options){
        ...
        this.methods = {
            ...
            addLocations: function(){
                ...
                if(locationField) {
                    _this.deleteMarkers();
                    dbObjects && dbObjects.forEach(function(object){
            ...
            */
            ...
            markerAddClickHandler : function(e){
                ...
                var location = new Location({
                    ...
                    lat: latlng[0],
                    lng: latlng[1],
                    img: _data.options.defaultMarkerImage
                });
            ...
            showPopover : function (object){
                ...
                _this.popover = new MapSVG.PopoverController({
                    ...
                    events: {
                        ...
                        'closed': function(mapsvg){
                            _data.options.popovers.resetViewboxOnClose && _this.viewBoxReset();
